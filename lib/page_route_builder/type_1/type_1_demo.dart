...
import 'package:flutter_common_demo/page_route_builder/type_1/page_route_animator.dart';
import 'package:flutter_common_demo/page_route_builder/type_1/route_animation.dart';

/// This widget is the root of your app.
/// Note: Use "ctrl + F" to search in a page.
class Type1Demo extends StatelessWidget {
  const Type1Demo({Key? key}) : super(key: key);
