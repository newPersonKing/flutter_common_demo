...
import 'package:flutter_common_demo/hyper_effects/effect_builder.dart';
import 'package:flutter_common_demo/hyper_effects/effects/effect.dart';
...
extension ClipEffectExtension on Widget {
  ...
  Widget clipCorners([
    ...
    [num topLeft, num topRight, num bottomRight, num bottomLeft] =>BorderRadius.only(
