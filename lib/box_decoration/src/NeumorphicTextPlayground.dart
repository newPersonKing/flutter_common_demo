...
import 'package:flutter_common_demo/box_decoration/src/widget/icon.dart';
import 'package:flutter_common_demo/box_decoration/src/widget/text.dart';
...
class __PageState extends State<_Page> {
  ...
  Widget _configurators() {
    final Color buttonActiveColor = Colors.red;
