...
import 'package:flutter_common_demo/text/rich_text_1/view/config.dart';
import 'package:flutter_common_demo/text/rich_text_1/view/multi_highlight_text.dart';
import 'package:flutter_common_demo/text/rich_text_1/widget/tooltip.dart';
  ...
  List<InlineSpan> _onDecorateBuilder(List<TextSpanStylesConfig> list) {
    ...
    for (int i = 0; i < list.length; i++) {
      ...
      CorrectItem? correctItem = list[i]
          .configs?.firstWhereOrNull((element) => element.customConfig != null)
          ?.customConfig;
      if (correctItem != null) {
