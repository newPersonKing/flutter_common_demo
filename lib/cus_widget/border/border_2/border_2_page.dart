...
import 'package:flutter_common_demo/cus_widget/border/border_2/progress_border.dart';



class Border2Page extends StatefulWidget {
  const Border2Page({super.key});


  @override
  State<Border2Page> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Border2Page>
