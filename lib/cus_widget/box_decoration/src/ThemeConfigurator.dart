...
import 'package:flutter_common_demo/cus_widget/box_decoration/src/ThemeColorSelector.dart';
...
class _ThemeConfiguratorState extends State<_ThemeConfiguratorDialog> {
  ...
  Widget intensitySelector() {
    final intensity = NeumorphicTheme.intensity(widget.contextContainingTheme) ?? 0.5;
    return Row(
      children: <Widget>[
        const Padding(
  ...
  Widget depthSelector() {
    final depth = NeumorphicTheme.depth(widget.contextContainingTheme) ?? 1;
