...
import 'package:flutter_common_demo/cus_widget/box_decoration/src/shape/beveled_path_provider.dart';
import 'package:flutter_common_demo/cus_widget/box_decoration/src/shape/circle_path_provider.dart';
import 'package:flutter_common_demo/cus_widget/box_decoration/src/shape/neumorphic_path_provider.dart';
import 'package:flutter_common_demo/cus_widget/box_decoration/src/shape/rect_path_provider.dart';
import 'package:flutter_common_demo/cus_widget/box_decoration/src/shape/rrect_path_provider.dart';
import 'package:flutter_common_demo/cus_widget/box_decoration/src/shape/stadium_path_provider.dart';
...
class NeumorphicBoxShape {
  ...
  const NeumorphicBoxShape.rect() : this._(const RectPathProvider());
   ...
   NeumorphicBoxShape.stadium() : this._( const StadiumPathProvider());
