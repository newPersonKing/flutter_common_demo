...
import 'package:flutter_common_demo/paint/paint_text_page.dart';
          ...
          children: [
            commonItem("绘制四边阴影",(){
              Navigator.push(context, MaterialPageRoute(builder: (context){
                return  const FourShadowPage();
              }));
            }),
            commonItem("文本绘制",(){
              Navigator.push(context, MaterialPageRoute(builder: (context){
                return  const PaintTextPage();
              }));
            }),
            commonItem("段 绘制",(){
              Navigator.push(context, MaterialPageRoute(builder: (context){
                return  const SegmentPage();
              }));
            }),
            commonItem("绘制虚线",(){
              Navigator.push(context, MaterialPageRoute(builder: (context){
            ...
            commonItem("透明图片",(){
              Navigator.push(context, MaterialPageRoute(builder: (context){
                return const KTransparentImagePage();
              }));
            }),
            commonItem("绘制移动图片",(){
              Navigator.push(context, MaterialPageRoute(builder: (context){
