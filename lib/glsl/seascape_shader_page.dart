...
class SeascapeShaderPage extends StatefulWidget {
  ...
  @override
  State<SeascapeShaderPage> createState() => _SeascapeShaderPageState();
}

class _SeascapeShaderPageState extends State<SeascapeShaderPage>  {
  ...
  void _loadShader() async {
    String path = 'shaders/seascape.glsl';
