...
class OctagramsShaderPage extends StatefulWidget {
  const OctagramsShaderPage({super.key});

  @override
  State<OctagramsShaderPage> createState() => _OctagramsShaderPageState();
}

class _OctagramsShaderPageState extends State<OctagramsShaderPage>  {
  ...
  void _loadShader() async {
    String path = 'shaders/octagrams.glsl';
