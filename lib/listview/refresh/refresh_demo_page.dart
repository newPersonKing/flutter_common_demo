...
// 知识点
// 1 notification.dragDetails 这个值如果为null 代表这个滑动不是手指滑动触发的
// 2 notification.metrics 这个对象里面存储着滑动列表的一些信息 比如 滑出屏幕的距离 屏幕中内容的长度 以及 未滑入屏幕大距离
...
class _RefreshDemoPageState extends State<RefreshDemoPage> {
  ...
  // GlobalKey 在当widget 挂载在widget tree上面的时候 如果是 GlobalKey 会注册到全局的map中
  // value 是 widget 对应的element
  /*if (key is GlobalKey) {
